...
public class ListIterator {
    ...
    public static int maxStream( List<Integer> list ) {
        return list.stream().reduce( Integer.MIN_VALUE, Integer::max );
    }

    public static int maxParallelStream( List<Integer> list ) {
        return list.parallelStream().reduce( Integer.MIN_VALUE, Integer::max );
    }
    ...
    public void test() {
        ...
        runWarmUp( ListIterator::maxStream, list );
        runWarmUp( ListIterator::maxParallelStream, list );
        ...
        runTest( ListIterator::maxStream, list );
        System.out.print( "maxParallelStream" );
        runTest( ListIterator::maxParallelStream, list );
